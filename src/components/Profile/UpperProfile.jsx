  ...
  if (displaycode) {
    ...
    return (
      <>
        ...
        />
        <CodeShowCase
          code={`<div className="bg-[url(https://rb.gy/0t2u0m)] bg-no-repeat bg-cover bg-center h-fit w-full rounded-lg border-2 border-indigo-500  p-4 text-center shadow-lg dark:bg-gray-800">
          <figure className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-500 dark:bg-indigo-600">
            <img
              src="https://rb.gy/0t2u0m"
              alt=""
